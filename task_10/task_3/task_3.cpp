...
public:
	...
	{ //feet is integer part feet =
		static_cast<int>(fltfeet); inches = 12 * (fltfeetfeet); //inches is what's left
...
Distance operator * (Distance d1, Distance d2)
{
	...
	float fltfeet2 = d2.feet + d2.inches / 12; float multfeet =
		fltfeet1 * fltfeet2; //find the product return
	Distance(multfeet); //return temp Distance
}
////////////////////////////////////////////////////////////////
int main()
{
