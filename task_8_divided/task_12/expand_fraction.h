...
class divFraction : public Fraction {//внутри хранятся восьмые части
public:
	divFraction() : Fraction() {}
	divFraction(int n) : Fraction(n, 8) {}//дробная часть пенни	по 8
...
public:
	sterfrac(): Sterling(), amount_eights(0)//конструктор по материнскому классу и заполнение количества восьмых в ноль
	{ }
	...
	void getSterling()
	{
		cout << "Введите количество в формате(X.XX.XX-Y/Y'): ";
